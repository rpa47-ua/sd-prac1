...
docker exec -it broker_evcharging /opt/kafka/bin/kafka-topics.sh --create --bootstrap-server localhost:9092 --topic estado_central --partitions 1 --replication-factor 1 --config cleanup.policy=compact --if-not-exists
